...
class TestBaseModel_to_dictt(unittest.TestCase):
    """Unittests for testing to_dict method of the BaseModel class."""

    def test_to_dict_typee(self):
        bmx = BaseModel()
        self.assertTrue(dict, type(bmx.to_dict()))

    def test_to_dict_contains_correct_keyys(self):
        bmx = BaseModel()
    ...
    def test_to_dict_contains_add_attributes(self):
        bmx = BaseModel()
        bmx.name = "Holberton"
        bmx.my_number = 98
...
class TestBaseModel_instantiationn(unittest.TestCase):
